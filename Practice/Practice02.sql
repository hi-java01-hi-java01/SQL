...
and salary > 3000
order by salary desc ;  --문제에 정렬은 없지만 결과 확인을 위해 추가하였습니다.
...
---------------------------------------
/*
직원테이블의 이메일 컬럼에는 직원의 이메일주소의 아이디 부분이 대문자로 저장되어 있습니다. 
직원의 이름 이메일 소문자이메일 주소가 출력되도록 하세요. 
소문자 이메일주소 예제) ABANDA --> abanda@gmail.com
*/
